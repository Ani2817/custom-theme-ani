  ...
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.countdown.min.js"></script>
  ...
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.fancybox.min.js"></script>
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.sticky.js"></script>
  <script src="<?php echo get_bloginfo('template_url');?>/js/isotope.pkgd.min.js"></script>
